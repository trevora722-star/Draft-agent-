...
EVENTS = {
    ...
    "prom": {
        ...
        "shots": [
            ...
            ("Dinner with friends", "Round banquet tables of students in gowns and tuxedos eating dinner together and talking, plain unlabeled bottles of water at every place setting - no other drinks, no glasses or stemware anywhere - warm ballroom light.", 34),
            ("The speeches", "A student council president in formal wear giving a speech at a podium on stage, the ballroom of seated students listening and smiling, purple uplighting. On the tables only plain unlabeled bottles of water - no glasses, no stemware, no other drinks.", 36),
